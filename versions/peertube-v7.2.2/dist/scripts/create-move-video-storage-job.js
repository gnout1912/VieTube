            ...
            await createMoveJobIfNeeded({
                ...
                canProcessVideo: options => {
                    ...
                    return files.some(f => f.storage === FileStorage.FILE_SYSTEM) ||
                        (hls === null || hls === void 0 ? void 0 : hls.storage) === FileStorage.FILE_SYSTEM ||
                        (source === null || source === void 0 ? void 0 : source.storage) === FileStorage.FILE_SYSTEM ||
            ...
            await createMoveJobIfNeeded({
                ...
                canProcessVideo: options => {
                    ...
                    return files.some(f => f.storage === FileStorage.OBJECT_STORAGE) ||
                        (hls === null || hls === void 0 ? void 0 : hls.storage) === FileStorage.OBJECT_STORAGE ||
                        (source === null || source === void 0 ? void 0 : source.storage) === FileStorage.OBJECT_STORAGE ||
