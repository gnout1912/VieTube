...
exports.default = (function (ins) {
    ...
    if (options.customXMLNS) {
        (0, utils_1.addCustomXMLNS)(base.rss, options.customXMLNS);
    }
    if (options.language) {
    ...
    if (options.customTags) {
        (0, utils_1.addCustomTagsToObject)(base.rss.channel, options.customTags);
    }
    ...
    ins.items.map(function (entry) {
        ...
        if (entry.customTags) {
            (0, utils_1.addCustomTagsToObject)(item, entry.customTags);
        }
...
var formatEnclosure = function (enclosure, mimeCategory) {
    ...
    if (typeof enclosure === "string") {
        ...
        return { _attributes: { url: (0, utils_1.sanitize)(enclosure), length: 0, type: "".concat(mimeCategory, "/").concat(type_1) } };
    }
    var type = new URL(enclosure.url).pathname.split(".").slice(-1)[0];
    return { _attributes: __assign(__assign({ length: 0, type: "".concat(mimeCategory, "/").concat(type) }, enclosure), { url: (0, utils_1.sanitize)(enclosure.url) }) };
};
